...
#define NRF24_CE_DD     DDB3
#define NRF24_CE_PORT   PORTB
#define NRF24_CE_PIN    PB3

#define NRF24_CSN_DD    DDB4
#define NRF24_CSN_PORT  PORTB
#define NRF24_CSN_PIN   PB4
...
{
    NRF24_CSN_PORT |= _BV(NRF24_CSN_PIN);
}
...
{
    NRF24_CE_PORT |= _BV(NRF24_CE_PIN);
}
